...
#ifndef muzzleflashdecorator_hpp
#define muzzleflashdecorator_hpp
...
class MuzzleFlashDecorator : public WeaponDecorator
{
private:
...
public:
    MuzzleFlashDecorator(const char* obj_path, const char* tex_path);
    ~MuzzleFlashDecorator();
    void ProcessMuzzleFlash();
    void UpdateMuzzleFlashConstraintMatrix(glm::mat4 &matrix);
    void UpdateMuzzleFlashCounterToZero();
};

#endif /* muzzleflashdecorator_hpp */
